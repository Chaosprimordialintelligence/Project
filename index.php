...
<html lang = "eng">
	<head>
		<title>CCSIT Employee Attendance Record System</title>
								...
								<div class="text-center mb-4" id="log_display"></div>
									<form action="" id="att-log-frm" >
										<div class="form-group">
											<label for="eno" class="control-label">Enter your CCSIT Employee Number</label>
		...
		$(document).ready(function(){
			...
			$('.log_now').each(function(){
				$(this).click(function(){
					...
					if(eno == ''){
						alert("Please enter your CCSIT employee number");
					}else{
						$('.log_now').hide()		
						$('.loading').show()
						$.ajax({
