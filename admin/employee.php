...
<html lang="eng">
	<head>
		<title>Student List | CCSIT Employee Attendance Record System</title>
	...
	<body>
		...
		<div class="container-fluid admin" >
			<div class="alert alert-primary">CCSIT Employee List</div>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content panel-warning">
						<div class="modal-header panel-heading">
							...
							<h4 class="modal-title" id="myModallabel">Edit CCSIT Employee</h4>
						</div>
				...
				<div class="modal-dialog modal-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModallabel">Add new CCSIT Employee</h4>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
				...
				$.ajax({
					...
					success:function(resp){
						if(typeof resp !=undefined){
							...
							$('#new_employee .modal-title').html('Edit CCSIT Employee')
			...
			$('#new_emp_btn').click(function(){
				...
				$('[name="department"]').val('')
				$('[name="position"]').val('')
				$('#new_employee .modal-title').html('Add New CCSIT Employee')
				$('#new_employee').modal('show')
			})
		});
	</script>
